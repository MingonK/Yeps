...
public class S3Connection {
   ...
   accessKey = "AKIAJNZIUGXXPSLVYE6A",
   secretKey = "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";
    ...
    * @param bucket 버킷 이름
    * @param key 폴더/파일이름 이렇게 해서 올리면 폴더 자동으로 생김
    * @param file 니가 올릴 파일
    * @param contentType 콘텐트 타입인데 https://s3browser.com/features-content-mime-types-editor.aspx 여기 나와있다.
    * 콘텐트 타입에 jpg 올릴라면 "image/jpeg" 이런식으로 넣으면 된다.
    */
   ...
   public void putObjectAsync(final String bucket, final String key, final InputStream stream, final int size, final String contentType) {
