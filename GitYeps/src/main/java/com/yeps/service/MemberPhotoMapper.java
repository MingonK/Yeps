...
public class MemberPhotoMapper {
	...
	public MemberPhotoDTO getFile(String filename, int filenum) {
	...
	public List<MemberPhotoDTO> getfileListForMe(int evnum, int mnum) {
		...
		map.put("evnum", evnum);
		map.put("mnum", mnum);
		return sqlSession.MemberPhotoDTO("getfileListForMe", map);
	}
	...
	public List<MemberPhotoDTO> getTargetEventFiles(int evnum) {
		return sqlSession.selectList("getTargetEventFiles", evnum);
	}

	public MemberPhotoDTO getFYIEventFile(int evnum) {
