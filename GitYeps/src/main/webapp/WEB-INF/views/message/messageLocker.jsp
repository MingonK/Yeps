...
<!-- Message sendform -->
			...
			<form name="lockerform"  method="post">
				<table border="0" id="table">
					<tr>
						...
						<input type="button" name="msgBox" id="msgBox" value="msgBox" style="cursor:pointer;" onclick="lockerToMsgBox();"> 
                ...
                <c:if test="${map.yepsPager.curBlock > 1}">
                    <a href="javascript:list('${map.yepsPager.prevPage}','${map.lMode}')" style="cursor:pointer;">[이전]</a>
                </c:if>
  ...
  <script>
    ...
    $("#reply").click(function(){
    	...
    	document.lockerform.action = "message_reply?box=locker";
