...
<head>
	...
	<script type="text/javascript">
		...
		function ContentAndGradepointCheck(){
			if(document.review_writeF.gradepoint.value==""||document.review_writeF.content.value==""){
		...
		function show(gradepoint){
			if(locked==1){
				...
				for(i = 1; i<= 5; i++){
					...
					el.src = "getImage/gradepoint_no_color.png";	
				}
			}
			var i;
			var image;
			...
			for(i = 1; i <= gradepoint; i++){
				image = 'image' + i;
				el = document.getElementById(image);
				el.src = "getImage/gradepoint_yes_color.png";
			}
...
<%@ include file="../top.jsp" %>
		...
		<div class="review_write_Big_div">
			...
			<div class="review_write_BigInner_div">
				...
				<form name="review_writeF" action="review_insert" method="post" onsubmit="return ContentAndGradepointCheck()">
	
					<!-- 식당명 -->
			 	<div class="review_write_Top_div">
			 			<h1><a href="review_selectedres?rnum=${rnum}" class="review_write_Rname_font">${rname}</a></h1><br>
			 	</div>
		
						<!-- 가운데 박스칸  -->	
						<div class="review_write_Textarea_div" style="border: 1px solid gray;">	
							<div class="review_write_Gradepoint_div" >
								<span>
									<img id="image1" onmouseover="javascript:show(1)" onclick="javascript:mark(1)" onmouseout="javascript:noshow(1)" src="getImage/gradepoint_no_color.png">
									<img id="image2" onmouseover="javascript:show(2)" onclick="javascript:mark(2)" onmouseout="javascript:noshow(2)" src="getImage/gradepoint_no_color.png">
									<img id="image3" onmouseover="javascript:show(3)" onclick="javascript:mark(3)" onmouseout="javascript:noshow(3)" src="getImage/gradepoint_no_color.png">
									<img id="image4" onmouseover="javascript:show(4)" onclick="javascript:mark(4)" onmouseout="javascript:noshow(4)" src="getImage/gradepoint_no_color.png">
									<img id="image5" onmouseover="javascript:show(5)" onclick="javascript:mark(5)" onmouseout="javascript:noshow(5)" src="getImage/gradepoint_no_color.png">
								</span>
									<span id="gradepointText">Select rating to get started</span>
									<input type="hidden" name="gradepoint">
						    </div>
						    
							<textarea name="content"  rows="18" cols="82" style="overflow:hidden;" style="margin-left:10px;"
								placeholder="Your review helps others learn about great local businesses.&#13;&#10; 
Please don't review this business if you received a freebie for writing this review, 
or if you're connected in any way to the owner or employees."></textarea><p>
						</div>	
