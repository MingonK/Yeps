												...
												<div class="resIMG_div_10">
													<div class="resIMG_div_11">
														...
														<div class="resIMG_div_13">
															<input class="resIMG_input_1" type="text" id="" name="" autocomplete="off">
														</div>
													</div>	
												</div>
		...
		-->			
									...
									<div class="resIMG_div_53">
										...
										<ul class="resIMG_ul_4">
											...
											<li class="resIMG_li_5">
												...
												<b class="resIMG_b_4">${reviewcount}</b>
											    reviews
											</li>
										</ul>
									</div>
						...
						<div class="resIMG_div_54">
								...
								<div class="resIMG_div_56">
									<div class="resIMG_div_57">
										<div class="resIMG_div_star${gradepoint}">
											<img class="resIMG_img_4" height="303" width="84" alt="3.0 star rating" src="https://s3-media2.fl.yelpcdn.com/assets/srv0/yelp_design_web/9b34e39ccbeb/assets/img/stars/stars.png">
										</div>
							...
							<div class="resIMG_div_60">
								...
								<a class="resIMG_a_5" href="review_write?rnum=${rnum}">
